...
{
	private readonly PackedScene InnUpgradeItemScene = GD.Load<PackedScene>("res://scenes/components/UpgradeInnItem.tscn");
	...
	private void PopulateUpgradeList(Inn inn)
	{
		...
		foreach (var upgrade in availableUpgrades)
		{
			...
			item.GetNode<Label>("%UpgradeName").Text = Enum.GetName(typeof(InnUpgradeName), upgrade);
