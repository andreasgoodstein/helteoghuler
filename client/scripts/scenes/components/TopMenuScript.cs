...
public class TopMenuScript : VBoxContainer
{
    ...
    public override void _Ready()
    {
        ...
        GetNode<Button>("SceneButtonContainer/AdventureButton")
            .Connect("pressed", this, "GoToAdventure");
        ...
        PlayerInfo.Text =
            $"{player?.Name}  {TranslationServer.Translate("INN_OWNER")}  {player?.Inn?.Name}";
    }
